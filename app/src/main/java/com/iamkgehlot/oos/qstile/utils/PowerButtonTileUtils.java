package com.iamkgehlot.oos.qstile.utils;
...
import com.iamkgehlot.oos.qstile.QSAccessibilityService;
    ...
    public static boolean isAccessibilityServiceEnabled(Context context) {
        ...
        if (accessibilityManager != null) {
            ...
            for (AccessibilityServiceInfo enabledService : accessibilityServiceInfoList) {
                ...
                if (enabledServiceInfo.packageName.equals(context.getPackageName()) && enabledServiceInfo.name.equals(QSAccessibilityService.class.getName()))
                    return true;
            }
        }
        return false;
